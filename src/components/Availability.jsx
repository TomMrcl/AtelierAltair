...
export default function BookingSection({
  instagramUrl = siteContent.availability?.instagramUrl,
  onContactScrollId = siteContent.availability?.contactScrollId || "contact",
}) {
      ...
      <div className="mx-auto max-w-5xl px-4 py-20">
        ...
        <div className="mt-12 space-y-6">
            ...
            <p className="text-sm md:text-base text-[#3a4e3a]" style={{ fontFamily: "'Inter', sans-serif" }}>
              {siteContent.availability?.intro || "Pour réserver, contactez-moi directement via Instagram ou par message"}
            </p>
